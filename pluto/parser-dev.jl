...
# ╔═╡ dcbb7eaa-c79b-47e3-9c06-4ea2fd050a10
allenurl = "https://raw.githubusercontent.com/neelsmith/eagl-texts/main/texts/iliad-allen-filtered.cex"

# ╔═╡ 744fcee5-ab9e-45a8-84ce-b1b2cb353ae6
bkmenu = [
	(
	nothing => "all"),
	(1 => "1"),
...
md"""*Select a book to analyze*: $(@bind book Select(bkmenu; default = 6))"""
...
corpus = begin
	iliad = fromcex(allenurl, CitableTextCorpus, UrlReader)
	isnothing(book) ? iliad : CitableTextCorpus(filter(psg -> startswith(passagecomponent(psg.urn), "$(book)."), iliad.passages))
end
...
julia_version = "1.9.1"
manifest_format = "2.0"
project_hash = "058d19bf9e7f978902c8b6d54023f809ecc6d740"
